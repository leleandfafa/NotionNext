...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '尘十六', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '纹耀设计总司', // 作者简介
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/leleandfafa', // 你的github个人主页 例如 https://github.com/tangly1024
